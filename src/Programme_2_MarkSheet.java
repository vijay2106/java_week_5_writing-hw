...
public class Programme_2_MarkSheet {
    public static void main(String[] args) {
        ...
        while (mathsMarks < 0 || mathsMarks > 100) {
            System.out.print("nInvalid Input,Mark should between 0 to 100");
        ...
        printThemarSheet(name,rollNum,mathsMarks,scienceMarks,englishMarks,total,percentage,result,grade);
    ...
    public static void printThemarSheet(String name,int rollNum,int mathsMarks,int scienceMarks,int englishMarks,double
